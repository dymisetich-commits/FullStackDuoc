...
Posteriormente, iniciar XAMPP y levantar el servicio de MySQL. Las bases de datos se crearan automaticamente con el codigo, no es necesario hacerlo manual.
